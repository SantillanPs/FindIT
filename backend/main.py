...
import database
from routers import auth as auth_router, admin_users, found, lost, claims, notifications, media, categories, analytics, zones, admin_zones, colleges, feedbacks, assets, init, leaderboard
...
v1_router.include_router(found.admin_router)
v1_router.include_router(lost.router)
v1_router.include_router(lost.admin_router)
v1_router.include_router(claims.router)
v1_router.include_router(claims.admin_router)
