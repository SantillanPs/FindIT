          ...
          >
            ...
            {step === 5 && (
              <DetailsStep 
                ...
                title="Describe unique marks or features"
                description="Colors, brands, scratches, or stickers help us confirm matches."
                      ...
                      <div className="space-y-6">
                         <div className="p-10 bg-white/5 rounded-[3rem] border border-white/5 text-left space-y-4 shadow-2xl">
                            ...
                            <div className="pt-6 border-t border-white/5">
                               <p className="text-[11px] font-black text-slate-600 uppercase tracking-widest italic block mb-1">Reported by</p>
