        ...
        <div className="text-center mb-8 relative z-20">
           ...
           <div className="relative w-full max-w-[200px] mx-auto h-1.5 bg-slate-800/50 rounded-full overflow-hidden mb-3 shadow-inner border border-white/5">
                <motion.div 
                    ...
                    className="absolute top-0 left-0 h-full bg-gradient-to-r from-sky-500 to-sky-300 rounded-full"
                ></motion.div>
           </div>
              ...
              >
                    ...
                    >
                        ...
                        <div className="space-y-5 text-left mx-auto w-full">
                            <div className="grid grid-cols-2 gap-4">
                                <motion.div variants={{ hidden: { opacity: 0, y: 10 }, show: { opacity: 1, y: 0 } }} className="space-y-2 text-left">
                ...
                {step === 4 && (
                    ...
                    >
                        ...
                        <motion.div variants={{ hidden: { opacity: 0, scale: 0.95 }, show: { opacity: 1, scale: 1 } }} className="text-left w-full h-[250px] relative z-20 group">
                            <ImageUpload 
